        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          ...
          <div class="right-menu list-inline no-margin-bottom">    
            ...
            <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><img src="{{ asset('img/flags/16/GB.png') }}" alt="English"><span class="d-none d-sm-inline-block">English</span></a>
              <div aria-labelledby="languages" class="dropdown-menu"><a rel="nofollow" href="#" class="dropdown-item"> <img src="img/flags/16/DE.png" alt="English" class="mr-2"><span>German</span></a><a rel="nofollow" href="#" class="dropdown-item"> <img src="{{ asset('img/flags/16/FR.png') }}" alt="English" class="mr-2"><span>French  </span></a></div>
            </div>
            <!-- Log out               -->
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="{{ route('product.index')}}"> <i class="icon-grid"></i>add product</a></li>
      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="text-center">Order By User</h2>
            <div class="table">
                <table>
                    <tr>
                        <th>name</th>
                    ...
                    <tr>
                        ...
                        <td> <img src="{{ asset('storage/photos/'.$order->product->image) }}" width="50px"> </td>
                        <td>
                            @if($order->status == 'in progress') 
                                <span style="color: red">{{ $order->status }}</span>
                            @elseif ($order->status == 'on the way')
                             
                            <span style="color: rgb(251, 255, 0)">{{ $order->status }}</span>
                              @else
                              <span style="color: rgb(33, 211, 33)">{{ $order->status }}</span>
                            @endif
                        </td>
                        <td>
                            <a href="{{ route('ontheway',$order['id']) }}" class="btn btn-danger">on the way</a>
                            <a href="{{ route('delivery',$order['id']) }}" class="btn btn-success">delivery</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
