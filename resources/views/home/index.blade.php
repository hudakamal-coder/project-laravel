      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{asset('storage/photos/' . $row['image']) }}" alt="">
              </div>
              <div class="detail-box">
                <h6>{{ $row['title'] }}</h6>
              ...
              <div><a href="{{ route('detail',$row['id']) }}" class="btn btn-success btn-sm">Detail...</a> 
              <a href="{{ route('addcart',$row['id']) }}" class="btn btn-primary btn-sm">AddCart</a>
            </div>
              <div class="new">
                <span>
                  New
